...
expName = 'adaptive_staircase_task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\aishw\\Lab in Psychology Experiment\\Adaptive Staircase\\adaptive_staircase_task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisStair in stair:
        ...
        thisExp.addData('key_corr',key_resp.corr)
        # check responses
